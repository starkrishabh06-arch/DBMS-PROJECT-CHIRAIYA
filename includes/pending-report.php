...
<head>
  ...
  <title>ExpenseHeist – Pending Report</title>
...
function printReport(){
  ...
  nw.document.write('<style>body{font-family:Arial,sans-serif;color:#111;} table{border-collapse:collapse;width:100%;} td,th{border:1px solid #333;padding:6px 10px;} thead th{background:#8f0f0f;color:#fff;}</style>');
    ...
    <div class="card">
      <div class="card-header">
        <div class="row align-items-center">
          <div class="col-md-6">
            <h4 class="card-title"><i class="bx bx-time-five" style="color:var(--gold);margin-right:8px;"></i>Pending Report</h4>
          </div>
      ...
      <div class="card-body" id="printable">
        <div class="report-heading">
          <span class="report-label">Pending <?= ucfirst($rtype) ?> Report</span>
        ...
        <?php } else { echo "<p class='no-data'><i class='bx bx-info-circle'></i> No pending intel for this date range.</p>"; } ?>
      </div>
    </div>
  </div>
</div>
